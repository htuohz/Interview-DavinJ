...
###### react renders virtialDom so that customised (React) elements start with uppercase eg: "< App >Hello World< /App > and built-in (vanilla) elememts remain in lowwercase eg: < div >Hello World< /div >
